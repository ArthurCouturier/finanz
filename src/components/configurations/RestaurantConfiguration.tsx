...
import { ExportConfigurationButton } from "../buttons/DataImportButton.tsx";
      ...
      <CardHeader className="relative flex justify-center">
        ...
        <CardTitle className="flex w-full justify-center">
          <textarea
            ...
            maxLength={50}
            className="max-w-1/2 md:w-full text-center resize-none break-words"
          />
        </CardTitle>
        <Button
          className="absolute right-4 -top-1.5 blue"
          onClick={() => navigateTo("/chooseConfig/restaurant")}
        >
          Change config
        </Button>
      </CardHeader>
      <div className="w-full h-max flex justify-center">
        {showConfigWeek ? (
          <Card
            ...
            onClick={() => setShowConfigWeek(false)}
          >
          ...
          <Button
            className={`h-full flex items-baseline ${
              showConfigWeek && "w-5/6"
            }`}
