...
import { getAverageBasketPerWeek, getAverageDrinkBasketPerWeek, getAverageLunchBasketPerWeek, getCoversPerWeek } from "@/modules/StatisticsPerWeek";
                    ...
                    onClick={(e) => e.stopPropagation()}>
                        <div>
                            <h2 className="font-bold">
                                Average baskets over the week 🧺
                            </h2>
                            <div className="flex gap-6 mt-2">
                                <div className="flex flex-col">
                                    <p> Daily total : </p>
                                    <div className="flex items-center justify-center">
                                        <NumberFlow value={parseFloat(averageBasketPerWeek)} className="text-2xl font-bold mx-1" />
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="items-center justify-center flex">
                                        <NumberFlow value={parseFloat(averageDrinkBasketPerWeek)} className="text-2xl font-bold mx-1" />
                                        <p className="text-xl font-bold"> € /pers.</p>
                                    </div>
                                </div>
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex justify-center items-center">
                                        <NumberFlow value={parseFloat(averageLunchBasketPerWeek)} className="text-2xl font-bold mx-1" />
                                        <p className="text-xl font-bold"> € /pers.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-6 mt-2">
                                <div className="max-w-36 flex flex-col">
                                    ...
                                    <NumberFlow value={nbCovers} className="text-2xl font-bold" />
                                </div>
                                <div className="max-w-36 flex flex-col">
                                    <p> Average table settings per day : </p>
                                    <NumberFlow value={parseFloat((nbCovers / config.week.length).toFixed(2))} className="text-2xl font-bold" />
                                </div>
                            </div>
                        </div>
                    </div>
